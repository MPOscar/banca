...
@Document(collection = "TombolaCombinacionesDeTres")
@CompoundIndexes({
		@CompoundIndex(name = "combinacion", def = "{ 'combinacion': 1 }", unique = true)
})
public class TombolaCombinacionesDeTres extends Entidad {
	...
	public TombolaCombinacionesDeTres() {
	}

	public TombolaCombinacionesDeTres(String combinacion, int numeroDeVecesQueHaSalido, DateTime fechaTirada) {
		this.combinacion = combinacion;
		this.numeroDeVecesQueHaSalido = numeroDeVecesQueHaSalido;
		this.fechaTirada = fechaTirada;
	}

	public TombolaCombinacionesDeTres(DateTime fechaTirada) {
		this.fechaTirada = fechaTirada;
	}
